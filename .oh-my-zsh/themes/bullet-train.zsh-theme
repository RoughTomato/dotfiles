...
# End therompt, closing any open segments
prompt_end() {
...
# DISABLED!
# TODO: make it show only in javascript projects!
prompt_nvm() {
  local nvm_prompt
  echo count
  if [ `ls -l *.js 2>/dev/null | wc -l` != 0 ]; then
...
'
PROMPT=''
[[ $BULLETTRAIN_PROMPT_ADD_NEWLINE == false ]] && PROMPT="$PROMPT$NEWLINE"
